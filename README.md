...
3.Run npm start to start the development server and launch the app in your browser.<br>
4.Once the app is running, you will be presented with a list of quizzes to choose from. Simply click on the quiz you want to take and begin answering the questions. You will be given feedback on each question, and at the end of the quiz you will see your final score.<br>
